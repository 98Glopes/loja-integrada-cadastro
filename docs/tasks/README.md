...
| 08 | [Publicação no Cloudflare R2](08-publicacao-r2.md) | 07 | sonnet | concluída | [spec](../specs/tasks/08-publicacao-r2.md) — `ArmazenamentoImagensR2` (boto3) publica com `Content-Type`/`Cache-Control` corretos e confirma acessibilidade com HEAD real antes de contar a foto; falha em qualquer etapa aborta o produto (`erro-fotos`); contrato do port mantido sem alteração (ADR-006); 206 testes |
